...
import os
import time
from utils.time import time_logger
import torch_geometric

FILE = './datasets/ogbn_products_orig/ogbn-products.csv'
...
def get_raw_text_products(use_text=False, seed=0):
    data = torch.load('./datasets/ogbn_products/ogbn-products_subset.pt')
    text = pd.read_csv('./datasets/ogbn_products_orig/ogbn-products_subset.csv')
